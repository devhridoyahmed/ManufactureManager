...
class MaterialsRepository {
  MaterialsRepository({AppDatabase? appDatabase, Uuid? uuid})
  ...
  Future<Map<String, Object?>?> getMaterialById(String materialId) async {
    final Database db = await _appDatabase.database;
    final String businessId = await getBusinessId();
  ...
  Future<void> deactivateMaterial(String materialId) async {
    final Database db = await _appDatabase.database;
    final String businessId = await getBusinessId();
